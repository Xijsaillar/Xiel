...
bool XSprite::LoadPokemon() {
	for (int i = 0; i < NUM_POKEMON; i++) {
		std::string buffer =
				"data/Battlers/" + std::string(3 - std::to_string(i).length(), '0') + std::to_string(i) + ".png";
	...
	for (int i = 0; i < NUM_POKEMON; i++) {
		std::string buffer =
				"data/Battlers/" + std::string(3 - std::to_string(i).length(), '0') + std::to_string(i) + "b.png";
	...
	for (int i = 0; i < NUM_POKEMON; i++) {
		std::string buffer =
				"data/Battlers/" + std::string(3 - std::to_string(i).length(), '0') + std::to_string(i) + "s.png";
	...
	for (int i = 0; i < NUM_POKEMON; i++) {
		std::string buffer =
				"data/Battlers/" + std::string(3 - std::to_string(i).length(), '0') + std::to_string(i) + "sb.png";
